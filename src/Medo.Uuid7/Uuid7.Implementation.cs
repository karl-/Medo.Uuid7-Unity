...
namespace Medo {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        ...
        [ThreadStatic] private static long PerThreadLastMillisecond; // real time in milliseconds since 0001-01-01

        [ThreadStatic] private static long PerThreadMillisecondCounter; // usually real time but doesn't go backward

        [ThreadStatic] private static uint PerThreadMonotonicCounter; // counter that gets embedded into UUID
